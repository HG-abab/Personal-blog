  ...
  <div class="nav-item" @mouseover="showForm = true" @mouseleave="showForm = false">
    ...
    <transition name="slide-fade">
      <div v-if="showForm" class="hover-form">
        <ul>
          <a href="/category" style="color: #000">
            <li>
          ...
          <a href="/Timeline" style="color: #000">
            <li>
...
<script setup>
  import { ref } from "vue";
  import { Files, CaretBottom, CopyDocument, Clock, Discount } from "@element-plus/icons-vue";
